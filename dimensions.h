...
#define PORTEE_TIR_n1 4*XFENETRE/NBRE_CASES_X/PORTEE_INITIALE
#define PORTEE_TIR_n2 6*XFENETRE/NBRE_CASES_X/PORTEE_INITIALE
#define PORTEE_TIR_n3 9*XFENETRE/NBRE_CASES_X/PORTEE_INITIALE
